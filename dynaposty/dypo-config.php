...
function dypo_configDisplay() {
	global $dypo_envTest, $dypo_URLVar, $dypo_setCookie, $dypo_cookieExpire, $dypo_shortcodes, $dypo_valueSets, $dypo_values;
		...
		<div id="dypo_mainSettings">
			...
			<tr>
				<th scope="row">
					<label for="dypo_setCookie">
						<?_e('Set a cookie to save shortcode values');?>?
					</label>
				</th>
			...
			<tr>
				...
				<tr id="<?=$vsID?>" class="dypo_row<?=$vsID?> dypo_editRow" >
					<td class="dypo_editable dypo_strong" >
						<span id="dypo_setName|<?=$vsID?>"><?=$vsName?></span>
			...
			//<![CDATA[
				...
				jQuery(document).ready( function(){ 
					...
					jQuery('.dypo_editable').attr('title','click to edit').click( function () {
						dypo_editCell(this);
					});
...
<?php
} // end function dypo_configDisplay
